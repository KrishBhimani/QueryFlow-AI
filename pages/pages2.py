...
st.markdown('<h1 class="main-title">📊 PDF Query System</h1>', unsafe_allow_html=True)
st.markdown('<p class="subtitle">Upload PDFs and query their content with advanced AI processing.</p>', unsafe_allow_html=True)
